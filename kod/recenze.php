...
<body>
    ...
    <div id="container">
        ...
        $article_id = $_GET['id'];
        ?>
        <form action="proces_recenze.php" method="POST">
            <label for="article_id">ID článku:</label>
            <!-- Zobrazí ID článku z URL jako skryté pole -->
            <input type="text" id="article_id" name="article_id" value="<?php echo $article_id; ?>" readonly>
