...
<body>
    ...
    <div id="container">
        ...
        <table>
            ...
            <tbody>
            <?php
            // Dotaz pro získání recenzí seřazených podle id clanku
            $sql = "SELECT recenze.id_recenze, clanky.nazev AS nazev_clanku, recenze.obsah_recenze AS obsah_recenze
                    FROM recenze
                    INNER JOIN clanky ON recenze.id_clanku = clanky.id_clanku
                    ORDER BY recenze.id_recenze"; // Přidáváme i id_recenze
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row["obsah_recenze"] . "</td>";
                    echo "<td><a href='smazatrecenzi.php?id=" . $row['id_recenze'] . "'>Smazat</a></td>"; // Používáme id_recenze pro smazání
                    echo "</tr>";
                }
            } else {
                echo "<tr><td colspan='3'>Žádné recenze k zobrazení</td></tr>";
            }
            ?>
            </tbody>
        </table>
